...
latex_documents = [
  ('index', 'DnaFeaturesViewer.tex', u'DnaFeaturesViewer Documentation',
   u'Zulko', 'manual'),
]
...
man_pages = [
    ('index', 'DnaFeaturesViewer', u'PACKAGE_NAME Documentation',
     [u'Zulko'], 1)
]
...
texinfo_documents = [
  ('index', 'DnaFeaturesViewer', u'DnaFeaturesViewer Documentation',
   u'Zulko', 'DnaFeaturesViewer', 'One line description of project.',
   'Miscellaneous'),
]
